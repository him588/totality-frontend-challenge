...
//         <Header />
//       </div>
//       <div className=" px-8 h-[500px] flex flex-col ">
...
//         </div>
//       </div>
//       <div className="h-[100px] w-full px-8 ">
//         <SearchBar />
//       </div>
//     </div>
//   );
    ...
    <div className="w-full bg-gradient-to-br from-[#fcf3ea] to-[#d8ebf9] flex flex-col gap-3 pb-4">
      ...
      <div className="px-4 md:px-8 h-[500px] flex flex-col">
        <div className="h-full w-full flex flex-col md:flex-row gap-2">
          <div className="h-[300px] md:h-full w-full md:w-[70%] bg-red-300 rounded-2xl overflow-hidden">
            <Image
              alt=""
              src={
                "https://images.unsplash.com/photo-1516455207990-7a41ce80f7ee?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
