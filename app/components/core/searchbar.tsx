...
//   return (
//     <div className="w-full h-full py-4 bg-white rounded-2xl flex flex-wrap items-center justify-between gap-2 px-2">
...
//         <div className=" overflow-hidden w-full md:w-[20%] h-[60px] border-[2px] border-solid border-[grey] border-opacity-50 rounded-full flex items-center gap-4 px-3">
//           <LocationIcon h={30} w={30} c="#3b3b3b" />
//           <div className="flex-1">
//             <p className="text-[grey] text-base md:text-xl">Location</p>
//             <input
...
//               className="text-base md:text-xl w-full cursor-pointer outline-none font-semibold text-[#3b3b3b] text-opacity-90 placeholder:text-opacity-90 placeholder:text-[#3b3b3b]"
//             />
//           </div>
//         </div>
...
//           <div className="flex-1">
//             <p className="text-[grey] text-base md:text-xl">Property Type</p>
//             <input
//               onClick={() => setOpen(true)}
//               type="text"
//               readOnly
...
//           <div className="flex-1">
//             <p className="text-[grey] text-base md:text-xl">Price</p>
//             <input
//               onClick={() => setOpen(true)}
//               type="text"
...
//           <div className="flex-1">
//             <p className="text-[grey] text-base md:text-xl">Bedroom</p>
//             <input
//               onClick={() => setOpen(true)}
//               type="text"
//               value={roomValue}
